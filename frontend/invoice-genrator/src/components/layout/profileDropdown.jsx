...
const ProfileDropdown = ({ isOpen, onToggle, avatar, companyName, email, onLogout }) => {
  ...
  return (
    <div className="relative">
      <button
        onClick={onToggle}
        className="flex items-center space-x-3 p-2 rounded-xl hover:bg-gray-500 transition-colors duration-200"
      >
        {avatar ? (
      ...
      {isOpen && (
        <div className="absolute mt-2 w-56 bg-white border border-gray-200 rounded-xl shadow-lg z-50 py-2">
